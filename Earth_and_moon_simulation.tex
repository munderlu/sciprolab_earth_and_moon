...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{class_diagram.png}}
\caption{Bild}
\end{figure}
...
\prompt{In}{incolor}{ }{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
\PY{c+c1}{\PYZsh{} \PYZhy{}\PYZhy{}\PYZhy{} AUFGABE 2.2: Systematischer Durchlauf aller geforderten Theia\PYZhy{}Konfigurationen \PYZhy{}\PYZhy{}\PYZhy{}}
\PY{c+c1}{\PYZsh{} Ablauf dieser Zelle in drei Schritten:}
\PY{c+c1}{\PYZsh{}   1) Hilfsfunktionen definieren (Sim aufbauen, Abstandsverlauf, Körper finden, ein Szenario laufen lassen)}
\PY{c+c1}{\PYZsh{}   2) Alle 9 Kombinationen (3 Geschwindigkeiten x 3 Zielrichtungen) durchrechnen}
\PY{c+c1}{\PYZsh{}   3) Ergebnisse als Tabelle ausgeben und die kollisionsfreien Fälle herausfiltern}
\PY{k+kn}{import}\PY{+w}{ }\PY{n+nn}{io}\PY{o}{,}\PY{+w}{ }\PY{n+nn}{contextlib}
\PY{k+kn}{import}\PY{+w}{ }\PY{n+nn}{numpy}\PY{+w}{ }\PY{k}{as}\PY{+w}{ }\PY{n+nn}{np}

\PY{n}{KM\PYZus{}PER\PYZus{}S\PYZus{}TO\PYZus{}M\PYZus{}PER\PYZus{}DAY} \PY{o}{=} \PY{l+m+mi}{1000} \PY{o}{*} \PY{l+m+mi}{86400}   \PY{c+c1}{\PYZsh{} km/s \PYZhy{}\PYZgt{} m/Tag}

\PY{k}{def}\PY{+w}{ }\PY{n+nf}{baue\PYZus{}erde\PYZus{}mond\PYZus{}sim}\PY{p}{(}\PY{n}{time\PYZus{}step}\PY{p}{)}\PY{p}{:}
\PY{+w}{    }\PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}Frische Simulation mit ruhender Erde und Mond auf stabiler Kreisbahn.\PYZdq{}\PYZdq{}\PYZdq{}}
    \PY{c+c1}{\PYZsh{} Für jedes Szenario wird bewusst eine NEUE Simulation gebaut, damit sich die}
    \PY{c+c1}{\PYZsh{} Läufe nicht gegenseitig beeinflussen (gleiche Startbedingungen für jeden Test).}
...
\PY{+w}{    }\PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}Gibt (tage\PYZus{}array, abstand\PYZus{}km\PYZus{}array) bis zum frühesten Kollisionsende zurück.\PYZdq{}\PYZdq{}\PYZdq{}}
    \PY{c+c1}{\PYZsh{} Greift auf die gespeicherte history beider Körper zu und berechnet pro Zeitschritt}
    \PY{c+c1}{\PYZsh{} den euklidischen Abstand. Wird unten für das Abstandsdiagramm gebraucht.}
    ...
    \PY{n}{n} \PY{o}{=} \PY{n+nb}{min}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{ha}\PY{p}{)}\PY{p}{,} \PY{n+nb}{len}\PY{p}{(}\PY{n}{hb}\PY{p}{)}\PY{p}{)}                          \PY{c+c1}{\PYZsh{} auf gemeinsame Länge kürzen}
    \PY{n}{tage} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{arange}\PY{p}{(}\PY{n}{n}\PY{p}{)} \PY{o}{*} \PY{n}{sim}\PY{o}{.}\PY{n}{time\PYZus{}step}                \PY{c+c1}{\PYZsh{} Schrittindex \PYZhy{}\PYZgt{} Tage}
    \PY{n}{dist} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{linalg}\PY{o}{.}\PY{n}{norm}\PY{p}{(}\PY{n}{ha}\PY{p}{[}\PY{p}{:}\PY{n}{n}\PY{p}{]} \PY{o}{\PYZhy{}} \PY{n}{hb}\PY{p}{[}\PY{p}{:}\PY{n}{n}\PY{p}{]}\PY{p}{,} \PY{n}{axis}\PY{o}{=}\PY{l+m+mi}{1}\PY{p}{)} \PY{o}{/} \PY{l+m+mi}{1000}   \PY{c+c1}{\PYZsh{} Meter \PYZhy{}\PYZgt{} km}
    \PY{k}{return} \PY{n}{tage}\PY{p}{,} \PY{n}{dist}


\PY{k}{def}\PY{+w}{ }\PY{n+nf}{finde\PYZus{}koerper}\PY{p}{(}\PY{n}{sim}\PY{p}{,} \PY{n}{name}\PY{p}{)}\PY{p}{:}
\PY{+w}{    }\PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}Liefert den noch lebenden Körper mit genau diesem Namen, sonst None.\PYZdq{}\PYZdq{}\PYZdq{}}
    \PY{c+c1}{\PYZsh{} Nach einer Verschmelzung heißt der Körper z.B. \PYZdq{}Erde+Theia\PYZdq{}; ein exakter}
    \PY{c+c1}{\PYZsh{} Namensvergleich liefert daher None, sobald der Einzelkörper nicht mehr existiert.}
...
\PY{+w}{    }\PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}}
\PY{l+s+sd}{    Baut Erde+Mond, injiziert Theia und lässt das System laufen.}
\PY{l+s+sd}{    Der Kollisionstag wird direkt beim Schritt erfasst, an dem sich die}
\PY{l+s+sd}{    Körperzahl verringert (= Verschmelzung), statt ihn nachträglich zu raten.}
\PY{l+s+sd}{    Die kleinsten Abstände messen wir dabei mit der Methode}
\PY{l+s+sd}{    Body.get\PYZus{}distance\PYZus{}to\PYZus{}body, solange Theia und Erde/Mond noch getrennt sind.}
\PY{l+s+sd}{    Returns: (sim, ergebnis\PYZhy{}dict)}
\PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
    \PY{n}{sim} \PY{o}{=} \PY{n}{baue\PYZus{}erde\PYZus{}mond\PYZus{}sim}\PY{p}{(}\PY{n}{time\PYZus{}step}\PY{p}{)}
    \PY{c+c1}{\PYZsh{} Geschwindigkeit von km/s in m/Tag umrechnen, da die Simulation in Tagen rechnet.}
    ...
    \PY{p}{)}
    \PY{c+c1}{\PYZsh{} setup\PYZus{}theia gibt eine print\PYZhy{}Meldung aus; die unterdrücken wir hier bewusst,}
    \PY{c+c1}{\PYZsh{} damit die spätere Ergebnistabelle nicht von 9 Meldungen zugemüllt wird.}
    \PY{k}{with} \PY{n}{contextlib}\PY{o}{.}\PY{n}{redirect\PYZus{}stdout}\PY{p}{(}\PY{n}{io}\PY{o}{.}\PY{n}{StringIO}\PY{p}{(}\PY{p}{)}\PY{p}{)}\PY{p}{:}
        \PY{n}{controller}\PY{o}{.}\PY{n}{setup\PYZus{}theia}\PY{p}{(}\PY{n}{sim}\PY{p}{)}

    \PY{c+c1}{\PYZsh{} \PYZhy{}\PYZhy{}\PYZhy{} Schritt\PYZhy{}Schleife: Kollisionstag und kleinste Abstände erfassen \PYZhy{}\PYZhy{}\PYZhy{}}
    \PY{n}{steps} \PY{o}{=} \PY{n+nb}{int}\PY{p}{(}\PY{n}{total\PYZus{}time} \PY{o}{/} \PY{n}{time\PYZus{}step}\PY{p}{)}
    \PY{n}{anzahl\PYZus{}koerper} \PY{o}{=} \PY{n+nb}{len}\PY{p}{(}\PY{n}{sim}\PY{o}{.}\PY{n}{bodies}\PY{p}{)}   \PY{c+c1}{\PYZsh{} Startwert (3 Körper); sinkt bei jeder Verschmelzung}
    \PY{n}{kollisions\PYZus{}tag} \PY{o}{=} \PY{k+kc}{None}
    \PY{n}{min\PYZus{}abstand\PYZus{}erde} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{inf}          \PY{c+c1}{\PYZsh{} mit Unendlich starten, damit das erste min() greift}
    ...
    \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{steps}\PY{p}{)}\PY{p}{:}
        ...
        \PY{c+c1}{\PYZsh{} Kleinste Abstände über die Kollegen\PYZhy{}Methode get\PYZus{}distance\PYZus{}to\PYZus{}body}
        \PY{c+c1}{\PYZsh{} (nur solange Theia noch als eigener Körper existiert, d.h. nicht verschmolzen ist)}
        ...
        \PY{c+c1}{\PYZsh{} Sobald weniger Körper als zuvor existieren, hat in genau diesem Schritt eine}
        \PY{c+c1}{\PYZsh{} Verschmelzung stattgefunden \PYZhy{}\PYZgt{} das ist der (erste) Kollisionstag.}
        \PY{k}{if} \PY{n}{kollisions\PYZus{}tag} \PY{o+ow}{is} \PY{k+kc}{None} \PY{o+ow}{and} \PY{n+nb}{len}\PY{p}{(}\PY{n}{sim}\PY{o}{.}\PY{n}{bodies}\PY{p}{)} \PY{o}{\PYZlt{}} \PY{n}{anzahl\PYZus{}koerper}\PY{p}{:}
            \PY{n}{kollisions\PYZus{}tag} \PY{o}{=} \PY{p}{(}\PY{n}{i} \PY{o}{+} \PY{l+m+mi}{1}\PY{p}{)} \PY{o}{*} \PY{n}{time\PYZus{}step}   \PY{c+c1}{\PYZsh{} genau dieser Schritt verschmolz}
        \PY{n}{anzahl\PYZus{}koerper} \PY{o}{=} \PY{n+nb}{len}\PY{p}{(}\PY{n}{sim}\PY{o}{.}\PY{n}{bodies}\PY{p}{)}

    \PY{c+c1}{\PYZsh{} Mit wem ist Theia verschmolzen?}
    \PY{c+c1}{\PYZsh{} Der Name des verschmolzenen Körpers (\PYZdq{}Theia+Erde\PYZdq{} o.ä.) wird an \PYZdq{}+\PYZdq{} zerlegt;}
    \PY{c+c1}{\PYZsh{} alle Teile außer \PYZdq{}Theia\PYZdq{} sind die getroffenen Körper.}
    ...
    \PY{c+c1}{\PYZsh{} Falls Theia gar nicht verschmolzen ist, gibt es keinen Kollisionstag}
...
\PY{c+c1}{\PYZsh{} \PYZhy{}\PYZhy{}\PYZhy{} Vollständige 3x3\PYZhy{}Matrix \PYZhy{}\PYZhy{}\PYZhy{}}
\PY{c+c1}{\PYZsh{} Jede Geschwindigkeit wird mit jeder Zielrichtung kombiniert \PYZhy{}\PYZgt{} 3 * 3 = 9 Läufe.}
\PY{c+c1}{\PYZsh{} Die Ergebnisse sammeln wir in einer Liste, die Simulationen in einem Dict (für die}
\PY{c+c1}{\PYZsh{} spätere Visualisierung gezielt abrufbar über das (Geschwindigkeit, Ziel)\PYZhy{}Tupel).}
\PY{n}{speeds}  \PY{o}{=} \PY{p}{[}\PY{l+m+mi}{3}\PY{p}{,} \PY{l+m+mi}{8}\PY{p}{,} \PY{l+m+mi}{12}\PY{p}{]}
\PY{n}{targets} \PY{o}{=} \PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{mitte}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{mond}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{erde}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}
...
\PY{+w}{    }\PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}Meter \PYZhy{}\PYZgt{} lesbarer km\PYZhy{}String.\PYZdq{}\PYZdq{}\PYZdq{}}
...
\PY{+w}{    }\PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}Kollisions\PYZhy{}Info mit Tag, oder Strich.\PYZdq{}\PYZdq{}\PYZdq{}}
...
\PY{c+c1}{\PYZsh{} Ergebnistabelle ausgeben (rechtsbündig formatiert für saubere Spalten)}
...
\PY{c+c1}{\PYZsh{} Kollisionsfreie Konfigurationen herausfiltern (= Antwort auf die Leitfrage)}
...
\prompt{In}{incolor}{ }{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
\PY{c+c1}{\PYZsh{} \PYZhy{}\PYZhy{}\PYZhy{} Abstandsdiagramm: Theia \PYZlt{}\PYZhy{}\PYZgt{} Erde für alle 9 Szenarien \PYZhy{}\PYZhy{}\PYZhy{}}
\PY{k+kn}{import}\PY{+w}{ }\PY{n+nn}{matplotlib}\PY{n+nn}{.}\PY{n+nn}{pyplot}\PY{+w}{ }\PY{k}{as}\PY{+w}{ }\PY{n+nn}{plt}
\PY{k+kn}{import}\PY{+w}{ }\PY{n+nn}{matplotlib}\PY{n+nn}{.}\PY{n+nn}{lines}\PY{+w}{ }\PY{k}{as}\PY{+w}{ }\PY{n+nn}{mlines}

\PY{n}{KOLLISIONS\PYZus{}RADIUS\PYZus{}KM} \PY{o}{=} \PY{p}{(}\PY{l+m+mi}{6371} \PY{o}{+} \PY{l+m+mi}{3389}\PY{p}{)}   \PY{c+c1}{\PYZsh{} Erde + Theia in km}
...
\PY{k}{for} \PY{n}{v} \PY{o+ow}{in} \PY{n}{speeds}\PY{p}{:}
    \PY{k}{for} \PY{n}{t} \PY{o+ow}{in} \PY{n}{targets}\PY{p}{:}
        ...
        \PY{c+c1}{\PYZsh{} Linienstärke leicht erhöht (1.8), damit die Strichmuster beim Zoom besser wirken}
        ...
        \PY{k}{if} \PY{n}{res}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{kollisions\PYZus{}tag}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]} \PY{o+ow}{is} \PY{o+ow}{not} \PY{k+kc}{None}\PY{p}{:}
            ...
            \PY{c+c1}{\PYZsh{} Der Text schwebt nun konstant 35.000 km über der Nulllinie, leicht nach rechts versetzt}
...
\PY{c+c1}{\PYZsh{} DER ZOOM: Wir betrachten nur noch die relevantesten 600.000 km (ca. 1.5x Monddistanz)}
...
\PY{n}{ax}\PY{o}{.}\PY{n}{grid}\PY{p}{(}\PY{k+kc}{True}\PY{p}{,} \PY{n}{color}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{white}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{alpha}\PY{o}{=}\PY{l+m+mf}{0.1}\PY{p}{)} \PY{c+c1}{\PYZsh{} Grid minimal sichtbarer gemacht}
...
\prompt{In}{incolor}{ }{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
\PY{c+c1}{\PYZsh{} \PYZhy{}\PYZhy{}\PYZhy{} Repräsentativer KOLLISIONS\PYZhy{}Fall (erster Treffer aus der Matrix) \PYZhy{}\PYZhy{}\PYZhy{}}
...
\PY{c+c1}{\PYZsh{} \PYZhy{}\PYZhy{}\PYZhy{} Repräsentativer KOLLISIONSFREIER Fall (erster Vorbeiflug aus der Matrix), falls vorhanden \PYZhy{}\PYZhy{}\PYZhy{}}
\PY{c+c1}{\PYZsh{} dynamic\PYZus{}scaling=True: mitlaufender Zoom, damit der Vorbeiflug an Erde/Mond gut erkennbar ist.}
...
\PY{c+c1}{\PYZsh{} \PYZhy{}\PYZhy{}\PYZhy{} MOND\PYZhy{}CRASH: Theia trifft gezielt den Mond \PYZhy{}\PYZhy{}\PYZhy{}}
...
\PY{c+c1}{\PYZsh{} Gleiche Visualisierungsfunktion wie oben.}
...
\PY{c+c1}{\PYZsh{} \PYZhy{}\PYZhy{}\PYZhy{} DOPPEL\PYZhy{}CRASH: Theia trifft BEIDE Körper in einem einzigen Anflug \PYZhy{}\PYZhy{}\PYZhy{}}
\PY{c+c1}{\PYZsh{} Eigener Lauf bei 6.2 km/s Richtung \PYZsq{}erde\PYZsq{}; total\PYZus{}time=20 Tage reicht, da beide}
\PY{c+c1}{\PYZsh{} Einschläge (Mond \PYZti{}6.7 Tage, Erde \PYZti{}7.4 Tage) lange davor passieren.}
...
\PY{c+c1}{\PYZsh{} Gleiche Visualisierungsfunktion wie oben: einmal mit mitlaufendem Zoom (dynamic\PYZus{}scaling=True),}
\PY{c+c1}{\PYZsh{} einmal mit festem Maßstab (dynamic\PYZus{}scaling=False).}
